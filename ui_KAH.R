    ...
    sidebarLayout(
        ...
        sidebarPanel(id="sidebar",
            ...
            radioButtons("playoffs", label = h4("Saison régulière/playoff"),
                         choices = list("Saison Régulièrere"=0,"Playoffs" = 1, "Saison rég.+playoff" = 2), 
                         selected = 0),
            ...
            #radio bouton pour choix domicile exterieur les deux
            radioButtons("dom_ext", label = h4("Domicile/ExtÃ©rieur"),
        ...
        mainPanel(id="main",
            ...
            tabsetPanel(type = "tabs",
                        tabPanel( class="my_style_1",id="IG","Le joueur en carriÃ¨re",htmlOutput("InfoGene"),
                        ...
                        tabPanel(id="tab","Stats Descriptives",
                                 tabsetPanel(type = "tabs",
                                             tabPanel(id="tab","FG% / 2pts vs 3 pts",
                                                      plotOutput("PctEvol")),
                                             tabPanel(id="tab","FG% / Saison RÃ©guliÃ¨re vs Playoffs",
                                             ...
                                             tabPanel(id="tab","mid_range FG% / position latÃ©rale",
                        ...
                        tabPanel("donnÃ©es", dataTableOutput("table"))
